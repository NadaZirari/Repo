...
void afficherMenu() {
    ...
    printf("10. Afficher le nombre d'etudiants ayant reussi dans chaque departement\n");
    printf("11. Rechercher un etudiant par son nom\n");
    printf("12. Afficher la liste des etudiants inscrits dans un departement specifique\n");
    printf("13. Trier les etudiants par leur nom (A-Z ou Z-A)\n");
    printf("14. Trier les etudiants par moyenne generale (du plus elevé au plus faible ou inversement)\n");
    printf("15. Trier les etudiants selon leur statut de reussite\n");
    printf("0. Quitter\n");
     printf("***************************************************************\n");
